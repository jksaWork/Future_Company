<div style='display:inline'>
    ...
    <!--end::Add customer-->
        ...
        <div class="modal fade" id="kt_modal_edit_customer_{{$item->id}}" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{ route('realstate.categories.update' , $item->id) }}" method="post"
                    >
                    @csrf
                    @method('PUT')
                        <!--begin::Modal header-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="#">
                                <!--begin::Input group-->
                                <x:text-input name='name' class='col-md-12' :value='$item->name' />
                                {{-- Select Box --}}
                                <x:select-options :options='$types'  :value='$item->type' name='type' class='col-md-12'/>
                            </div>
                            <!--end::Scroll-->
                        </div>
                        <!--end::Modal body-->
