...
@section('main-head', __('translation.school_spending_reports'))
@section('content')
<div class="post d-flex flex-column-fluid" id="kt_post">
               ...
               <div class="p-2 m-2">
                    <div class="row p-3 m-2">
                         <div class="form-group col-md-4">
                              ...
                              <select class="form-control col-md-6" name="" id="school_id">
                                   <option value=''>{{ __('translation.chose_the_school') }}</option>
                              ...
                              <div class="form-group ">
                                   ...
                                   <select class="form-control " name="" id="month_number">
                                        @for ($i = 1; $i < 13; $i++) <option value='{{$i}}'>
                                             {{$i . ' -- '. __('translation.'. date("M", mktime(null, null, null, $i, 1)));}}
                                             </option>
                                             @endfor
                                   </select>
                              </div>
     ...
     let rolesTable = $('#roles-table').DataTable({
          ...
          ajax: {
               url: '{{ route('school.reports.SchoolSpendingData') }}',
               data: function(q) {
                    q.year = year;
                    q.month = month;
          ...
          footerCallback: function(row, data, start, end, display) {
               ...
               $(api.column(3).footer()).html(
                    `${new Intl.NumberFormat().format(pageTotal - pageTotal2)}`);
               $(api.column(1).footer()).html(`${new Intl.NumberFormat().format(pageTotal)}`);
