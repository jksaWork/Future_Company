                                   ...
                                   <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable "
                                        ...
                                        <tfoot>
                                            <tr class='table-success'>
                                                <th colspan="3" style="text-align:center">{{ __('translation.total') }} : </th>
...
let rolesTable = $('#roles-table').DataTable({
     ...
     ajax: {
          url: '{{ route('school.reports.SchoolMonthlyData') }}',
          data:function(q){
            q.year = year;
            q.month = month;
     ...
     footerCallback: function (row, data, start, end, display) {
          ...
          //   Update footer
            ...
            $(api.column(4).footer()).html(`${new Intl.NumberFormat().format(pageTotal2)}`);
        },
});
