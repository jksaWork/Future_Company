									...
									<div class="col-xl-4">
										...
										<a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
											...
											<div class="card-body">
												...
												<!--end::Svg Icon-->
												{{-- <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{__('translation.Number_of_Employees')}}</div>
												<div class="fw-bold text-white">Lands, Houses, Ranchos, Farms</div> 
                                                <div class="">
                                                    <div class="text-white fw-bolder fs-2 mb-2 mt-5">
                                                        0.00
                                                    </div>
                                                    <div class="fw-bold text-white fs-4">الايرادات</div>
                                                </div>
											</div>
                                        </div>
											<!--end::Body-->
              ...
              {{-- <div class="row"> --}}
                ...
                {{-- <div class="col-xl-6 col-lg-6 col-6">
                    <div class="card pull-up">
                        <div class="card-content">
                            <div class="card-body">
                                <canvas id="spendings_data" width="600" height="400"></canvas>
                            </div>
                        </div>
                    </div>
                </div> --}}
