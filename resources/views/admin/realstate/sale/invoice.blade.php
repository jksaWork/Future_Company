                                    ...
                                    <div class="d-flex flex-end">
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="row g-5 mb-1">
                                                <div class="col-sm-12">
                                                    <div class="fw-bold fs-6 text-gray-600 mt-2"><span class="fw-bolder fs-4">
                                                        {{ __('translation.optration_type') }}</span> : <span class='mx-2'> {{ __('translation.sale_installment') }}</span> </div>
                                                </div>
                                            </div>
                                            ...
                                            <table class="table mb-3">
                                                ...
                                                <tbody>
                                                    <tr class="fw-bolder text-gray-700 fs-5 text-end">
                                                        <td class="d-flex align-items-center pt-6">{{ __('translation.recept')  }} {{
                                                            __('translation.installment_order_' .  $data->order_number)
                                                            }}</td>
                                                        {{-- <i class="fa fa-genderless text-danger fs-2 me-2"></i>{{ $data->price }}</td> --}}
                                                        {{-- <td class="pt-6">{{ $data->price }}</td> --}}
                                                        <td class="pt-6 text-dark fw-boldest">{{ number_format($data->amount,2) }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <div class="mw-300px">
                                                ...
                                                <div class="d-flex flex-stack mb-3">
                                                    ...
                                                    <!--end::Accountname-->
                                                    <!--begin::Label-->
                                                    <div class="text-end fw-bolder fs-6 text-gray-800">{{ number_format($data->amount,2) }}</div>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Item-->
                                                <!--begin::Item-->
