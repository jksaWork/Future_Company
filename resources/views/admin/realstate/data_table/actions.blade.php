...
<div style="min-width: 200px">
    ...
    <a href="{{ route('realstate.realstate.edit', $id) }}" class="btn btn-light-info btn-sm btn-icon me-1">
        ...
        <a href="{{ route('realstate.realstate.show', ['status' => true , 'realstate' => $id]) }}"
...
{{-- @if (auth()->user()->hasPermission('delete_admins')) --}}
    <form action="{{ route('realstate.realstate.destroy', $id) }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
        @csrf
        @method('delete')
