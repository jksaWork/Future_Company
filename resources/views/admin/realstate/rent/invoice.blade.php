                                    ...
                                    <div class="col-md-6 d-flex">
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="row g-5 mb-12">
                                                ...
                                                <div class="col-sm-12">
                                                    <!--end::Label-->
                                                    <div class="fw-bold fs-7 text-gray-600 ">{{ __('translation.Issue_For') }}:</div>
                                                    <!--end::Label-->
                                                    <!--end::Text-->
                                                    <div class="fw-bolder fs-6 text-gray-800">{{ $data->price }}</div>
                                                    <!--end::Text-->
                                                    <!--end::Description-->
                                                    <!--end::Description-->
                                                </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <!--end::Label-->
                                                    <div class="fw-bold fs-7 text-gray-600 ">{{ __('translation.Issue_By') }}:</div>
                                                    <!--end::Label-->
                                                    <!--end::Text-->
                                                    <div class="fw-bolder fs-6 text-gray-800">{{ setting('title') }}</div>
                                                    <!--end::Text-->
                                            ...
                                            <div class="row g-5 mb-11">
                                                ...
                                                <div class="col-sm-12">
                                                    <!--end::Label-->
                                                    <div class="fw-bold fs-7 text-gray-600 ">{{ __('translation.Added_date') }}:</div>
                                                    <!--end::Label-->
                                                    <!--end::Info-->
                                                    <div class="fw-bolder fs-6 text-gray-800 d-flex align-items-center flex-wrap">
                                                        <span class="pe-2">{{ $data->created_at }}</span>
