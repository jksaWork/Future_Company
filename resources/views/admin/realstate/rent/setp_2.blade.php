    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <div class="row">
                    <form action='{{route('realstate.Revenue')}}' method='post' id='#revnues'>
                        @csrf
                        <div class="col-md-12">
                            <input type='hidden' value='{{$realstate->id}}' name='realstate_id'/>
                            <input type='hidden' name='month_number' value='{{$month_number}}' />
                            <input type='hidden' name='owner_id' value='{{$realstate->CurrentOwner[0]->id}}' />
                        </div>
                        ...
                        <div class="pt-7">
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="">
                                <!--begin::Table head-->
                                @php
                                    $Owner = $realstate->CurrentOwner[0];
                                @endphp
                                <thead>
                                    <!--begin::Table row-->
                        ...
                        <div class="text-left pt-5">
                            <button class="btn btn-light-primary">
                                {{__('translation.recept_renvue')}}
                            </button>
                            <button class="btn btn-light-danger" type='reset' onclick="+++" >
