                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            {{-- <div class="menu-item px-3">
                                                <form action="{{ route('Employee.All_Employee.destroy', $employee->id) }}"
                                                    id='delteForm' method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}
                                                    <button type="submit" class="menu-link px-3 bg-light-danger"
                                            ...
                                            <div class="menu-item px-3">
                                                <form action="{{ route('Employee.All_Employee.destroy', $employee->id) }}" method="post" id='{{'owner_delete_from_' . $employee->id}}'>
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="#" onclick="document.getElementById('owner_delete_from_{{$employee->id}}').submit()" class="menu-link px-3 bg-light-danger "
