...
@section('main-head')
    {{ __('translation.employee_information') }}
                            ...
                            <div class="rounded border p-10">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="kt_tab_pane_5" role="tabpanel">
                                        ...
                                        <form method="post" action="{{ route('Employee.Upload_attachment.store') }}"
                                                ...
                                                @foreach ($images as $attachment)
                                                    <tr style='text-align:center;vertical-align:middle'>
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <form action="{{ route('Employee.Delete_attachment') }}"
                                                                ...
                                                                <input type="hidden" name="employees_name"
                                                                    value="{{ $attachment->employee->name }}">
                                                                <input type="hidden" name="employees_id"
                                                                    value="{{ $attachment->employee->id }}">
