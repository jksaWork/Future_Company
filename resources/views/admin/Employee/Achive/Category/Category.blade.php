...
@extends('layouts.admin.admin')
@section('main-head', __('translation.Categoires_recovery'))
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href='{{ route('Employee.categories.index', ['type' => request()->type]) }}'
...
<script>
   ...
   let rolesTable = $('#roles-table').DataTable({
       ...
       buttons: [
           'copy', {
               extend:'excel',
               text:'{{ __('translation.Categoires_recovery') }}' ,
           },

           { extend: 'print',
                   title: '@lang('translation.Categoires')',
         ...
         ajax: {
            url: '{{ route('Achive.Category.Achives') }}',
           data: function(q) {
               q.type = type;
