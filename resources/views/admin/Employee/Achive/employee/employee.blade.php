...
@extends('layouts.admin.admin')
@section('main-head', __('translation.employees_recovery'))
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href='{{ route('Employee.All_Employee.index', ['type' => request()->type]) }}'
...
<script>
   ...
   let rolesTable = $('#roles-table').DataTable({
       ...
       buttons: [
           ...
           { extend: 'print',
                   title: '@lang('translation.employees_recovery')',
         ...
         ajax: {
            url: '{{ route('Achive.employee.Achives') }}',
           data: function(q) {
               q.type = type;
