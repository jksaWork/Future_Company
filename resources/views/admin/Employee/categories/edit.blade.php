                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-body pt-0">
                        ...
                        <form action="{{ route('Employee.categories.update' , $category->id) }}" method="post">
                            ...
                            @method('PUT')
                            <div class="row">
                                <x:text-input name='categories_name' value='{{$category->categories_name}}' class='col-md-6' />
                                <div class="d-flex flex-column mb-3">
                                    <label class="fs-4 fw-bold mb-2">{{__('translation.description')}}</label>
                                    <textarea class="form-control form-control-solid" rows="1"value='{{$category->description}}'  name="description" placeholder="{{__('translation.description')}}"></textarea>
                                </div>
                                <div class='col-md-6'>
                                </div>
                                <div class="mt-4">
