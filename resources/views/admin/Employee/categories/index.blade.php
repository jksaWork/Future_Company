                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href='{{ route('Employee.categories.create', ['type' => request()->type]) }}'
                                class="btn btn-primary">{{ __('translation.Add_sections_for_employees') }}</a>
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
...
<script>
   ...
   let rolesTable = $('#roles-table').DataTable({
       ...
       buttons: [
         ...
         ajax: {
            url: '{{ route('Section.Category.hitory.data') }}',
           data: function(q) {
               q.type = type;
