...
@extends('layouts.admin.admin')
@section('main-head', __('translation.Staff_salaries'))
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href='{{ route('Employee.salaries.create', ['type' => request()->type]) }}'
                                class="btn btn-primary">{{ __('translation.add_salaries') }}</a>
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
...
@push('scripts')
    ...
    <script>
        ...
        let rolesTable = $('#roles-table').DataTable({
            ...
            ajax: {
                url: '{{ route('Section.salaries.hitory.data') }}',
                data: function(d) {
                    d.type = type;
                    d.status = status;
                    d.is_rent = is_rent;
