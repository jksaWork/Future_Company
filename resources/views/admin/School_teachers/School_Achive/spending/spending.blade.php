...
@extends('layouts.admin.admin')
@section('main-head', __('translation.spending_recovery'))
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href='{{ route('School.spending.index', ['type' => request()->type]) }}'
...
<script>
   ...
   let rolesTable = $('#roles-table').DataTable({
       ...
       buttons: [
           ...
           { extend: 'print',
                   title: '@lang('translation.spending_recovery')',
         ...
         ajax: {
            url: '{{ route('School_Achive.School_spending.Achives') }}',
           data: function(q) {
               q.type = type;
