                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href='{{ route('School.Teachers_allowances.index', ['type' => request()->type]) }}'
...
<script>
   ...
   let rolesTable = $('#roles-table').DataTable({
       ...
       buttons: [
           ...
           { extend: 'print',
                   title: '@lang('translation.employee_allowances_recovery')',
         ...
         ajax: {
            url: '{{ route('School_Achive.School_employee_allowances.Achives') }}',
           data: function(q) {
               q.type = type;
