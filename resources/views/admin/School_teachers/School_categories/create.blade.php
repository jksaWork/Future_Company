                    ...
                    <div class="card-body pt-0">
                        ...
                        {{ method_field('post') }}
                            <div class="row">
                                ...
                                <x:text-input name='categories_name' class='col-md-6' />
                                <div class="d-flex flex-column mb-3">
                                    <label class="fs-4 fw-bold mb-2">{{__('translation.description')}}</label>
                                    <textarea class="form-control form-control-solid" rows="1" name="description" value="{{ old('description') }}" placeholder="{{__('translation.description')}}"></textarea>
                                </div>
                                <div class='col-md-6'>
                                </div>
                                <div class="mt-4">
