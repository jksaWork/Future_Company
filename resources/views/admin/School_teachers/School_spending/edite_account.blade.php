...
@section('main-head')
    {{ __('translation.Modify_the_process') }}
@endsection
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-body pt-0">
                        ...
                        <form action="{{ route('School.account.update' , $type_accounts->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="fv-row mb-7 col-md-6 ">
                                    <input type="hidden" class="form-control form-control-solid"
                                        placeholder="" name="pro_id" value='{{$type_accounts->school_spendings_id}}'/>
                                
                                </div>
                                <div class="fv-row mb-7 col-md-6 ">
                                    <input type="hidden" class="form-control form-control-solid"
                                        placeholder="" name="status" value='{{$type_accounts->status}}'/>
                                ...
                                <div class="fv-row mb-7 col-md-6 ">
                                    ...
                                    <input type="number" class="form-control form-control-solid" value="{{$type_accounts->value}}"
                                ...
                                <div class="fv-row mb-7 col-md-6 ">
                                    ...
                                    <input class="form-control form-control-solid" name="month" value="{{$type_accounts->month}}"
