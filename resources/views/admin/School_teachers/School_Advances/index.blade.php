...
@extends('layouts.school.master')
@section('main-head', __('translation.Advancess'))
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="d-flex justify-conetnt-between align-items-center position-relative my-1 col-md-8">
                        ...
                        <div class="col-md-6  d-flex align-items-center position-relative my-1 ">
                            ...
                            {{-- <form action="{{ route('owners.index')}}" method="get"> --}}
                                ...
                                placeholder="{{ __('translation.search_with_created_at_value') }}" />
                    ...
                    ">
                            <div class="form-group">
                                <select class="form-control" name="" id="school_advances">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href='{{ route('School.Advances.create', ['type' => request()->type]) }}'
...
<script>
   ...
   let stauts, type, school_advances, from_date, id = @json(request()->id);
   let rolesTable = $('#roles-table').DataTable({
       ...
       buttons: [
           ...
           { extend: 'print',
                   title: '@lang('translation.Advancess')',
         ...
         ajax: {
            url: '{{ route('data.Advances.hitory.data') }}',
           data: function(q) {
               q.type = type;
               q.school_advances = school_advances;
   ...
   $('#school_advances').on('change', function() {
    school_advances = $(this).val();
       console.log(school_advances);
       rolesTable.ajax.reload();
   });
