                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="">{{ __('translation.allowances_vlue') }}</th>
                                    ...
                                    <tfoot>
                                        <tr class='table-success'>
                                            ...
                                            <th id=''colspan="2" style="font-weight:bolder;/* margin: 28%; */padding: 17px 137px;"></th>
...
<script>
   ...
   let stauts, type, school_teachers_allowances, end_month,being_month, id = @json(request()->id);
   let rolesTable = $('#roles-table').DataTable({
       ...
       buttons: [
         ...
         ajax: {
            url: '{{ route('School_reports.School_employee_allowances.report_data') }}',
           data: function(q) {
               q.type = type;
       ...
       footerCallback: function (row, data, start, end, display) {
        // console.log(footerCallback);
            ...
            $(api.column(4).footer()).html(`${new Intl.NumberFormat().format(pageTotal)}`);
