...
<div class="modal fade" id="kt_modal_add_customer_{{ $item->id }}" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{ route('supplier.update' , $item->id) }}" method="post">
                @csrf
                @method('PUT')
                <!--begin::Modal header-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="#">
                        <!--begin::Input group-->
                        <x:text-input name='name' value='{{ $item->name }}' class='col-md-12' />
                        <!--end::Input group-->
                        <x:text-area class='col-md-12' value='{{ $item->description }}' name='description'></x:text-area>
                        <!--begin::Input group-->
                    </div>
                    <!--end::Scroll-->
                </div>
                ...
                <div class="modal-footer ">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button class="btn btn-primary"> {{ __('translation.edit_data') }} </button>
                    <!--end::Button-->
                </div>
                <!--end::Modal footer-->
            </form>
