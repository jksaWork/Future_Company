...
<div style="min-width: 200px">
    ...
    <a href="{{ route('owners.edit', $id) }}" class="btn btn-light-info btn-sm btn-icon me-1">
        ...
        <a href="{{ route('owners.show', ['status' => true , 'owner' => $id]) }}"
...
{{-- @if (auth()->user()->hasPermission('delete_admins')) --}}
    <form action="{{ route('owners.destroy', $id) }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
        @csrf
        @method('delete')
