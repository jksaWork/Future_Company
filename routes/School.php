    ...
    function () {
        ...
        Route::middleware('auth:web')->group(function () {
            Route::prefix('School')->name('School.')->group(function () {
                ...
                Route::get('pluss_spending/{id?}', [School_SpendingController::class, 'pluss_spending'])->name('spending.pluss');
                Route::get('minus_spending/{id?}', [School_SpendingController::class, 'minus_spending'])->name('spending.minus');
                Route::resource('account', AccountController::class);
                Route::get('print_spendings/{id?}', [School_SpendingController::class, 'print_spending'])->name('spending.print');
