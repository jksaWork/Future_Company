...
Route::group(
    ...
    function () {
        ...
        Route::prefix('reports')->name('reports.')->middleware(['auth:admin'])->group(function () {
            ...
            Route::get('monthly-spending-renvues', [ReportController::class, 'MonthlyRealstateRenvueAndSpending'])->name('MonthlyRealstateRenvueAndSpending');
            Route::get('monthly-spending-data', [ReportController::class, 'MonthData'])->name('MonthData');
        });
