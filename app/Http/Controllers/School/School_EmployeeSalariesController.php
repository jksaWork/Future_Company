...
class EmployeeSalariesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.School_teachers.School_employee_allowances.index', compact('employee_allowances' ,'employee' ,'allowances'));
    } //end of index
    ...
    public function create(Employee $employee)
    {
        ...
        return view('admin.School_teachers.School_employee_allowances.create', compact('employees'));
    } //end of create
    ...
    public function edit(employee $employee, $id)
    {
        ...
        return view('admin.School_teachers.School_employee_allowances.edit', compact('allowances', 'employee_allowances'));
    } //end of edit
